...
@section('content')
    ...
    <h4>Pemasukan Outlet</h4>
    <h6>Pemasukan Outlet</h6>
    </div>
    <div class="row">
        <div class="col-sm-12">
        </div>
    ...
    <div class="search-input">
        <a onclick="addForm('{{route('pemasukan.store')}}')" class="btn btn-primary btn-sm">Tambah Transaksi Baru</a>
        <a type="button" onclick="deleteSelected('{{ route('pemasukan.delete_selected') }}')" class="btn btn-secondary btn-sm">Hapus</a>
...
@includeIf('module.kelolakas.pemasukan.form')
@endsection
@push('scripts')
<script>
  let table;

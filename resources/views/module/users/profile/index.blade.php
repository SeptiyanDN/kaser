...
<div class="page-header">
    ...
    <img src="https://dreamspos.dreamguystech.com/laravel/template/public/assets/img/customer/customer5.jpg" alt="img" id="blah">
    <div class="profileupload">
    <input type="file" id="imgInp">
    <a href="javascript:void(0);"><img src="https://dreamspos.dreamguystech.com/laravel/template/public/assets/img/icons/edit-set.svg" alt="img"></a>
    </div>
    </div>
...
@endif
    ...
    <div class="form-group">
    <label>Phone</label>
     <input type="text" placeholder={{auth()->user()->telepon}}>
    </div>
    </div>
    <div class="col-lg-6 col-sm-12">
    <div class="form-group">

...
@section('content')
    ...
    <div class="row">
        ...
        <h5 class="card-title">Menambahkan Role</h5>
        </div>
        <div class="card-body">

        <form action={{route('roles.create')}} method="POST">
            @csrf
            @include('module.role_permission.roles.partials.form-control',['submit'=>'Create'])
        </form>
        </div>
        </div>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="me-3" onclick="deleteData('{{route('roles.remove',$role->id)}}')">
